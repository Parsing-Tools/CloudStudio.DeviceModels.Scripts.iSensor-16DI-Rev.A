...
# Parsing + Configuration Script – iSensor-16DI - Rev. A

This **Parsing + Configuration** script is designed for the **iSensor-16DI** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – iSensor-16DI Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **iSensor-16DI** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
